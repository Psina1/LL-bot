...
CREATE INDEX IF NOT EXISTS ix_documents_lesson_date ON documents(lesson_date);
...
CREATE INDEX IF NOT EXISTS ix_program_media_lesson_date ON program_media(lesson_date);
