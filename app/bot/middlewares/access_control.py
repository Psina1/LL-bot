...
DENIED_TEXT = (
    "Привет!\n"
    "Этот бот – для участников программы «Лига Лидеров». Он недоступен для тех, кто не проходит обучение по программе.\n\n"
    "Увидимся в других проектах Корпоративного университета!"
)
